...
(function (global, factory) {
    ...
    var DEFAULTS = {
        ...
        // 4 -> Autoselect all (province, city and district school)  todo:联动
        // 5 -> Autoselect all (province, city and district school profession)  todo:联动
        autoselect: 0,
        // Show placeholder.
        placeholder: true,
    ...
    var SCHOOL = 'school';  //todo:联动
    var PROFESSION = 'profession';  //todo:联动
        ...
        function () {
            ...
            _createClass(Distpicker, [{
                ...
                value: function init() {
                    ...
                    $.each([PROVINCE, CITY, DISTRICT,SCHOOL,PROFESSION], function (i, type) { //todo:联动
                        if (data[type]) {
                ...
                value: function bind() {
                    ...
                    if (this.$province) {
                        this.$province.on(EVENT_CHANGE, this.onChangeProvince = $.proxy(function () {
                            ...
                            // _this2.output(DISTRICT, true); //todo:联动
                            _this2.output(DISTRICT);
                            _this2.output(SCHOOL);
                            _this2.output(PROFESSION,true);
                        }, this));
                    }

                    if (this.$city) {
                        this.$city.on(EVENT_CHANGE, this.onChangeCity = $.proxy(function () {
                            // return _this2.output(DISTRICT, true); //todo:联动
                            _this2.output(DISTRICT);
                            _this2.output(SCHOOL);
                            _this2.output(PROFESSION,true);
                        }, this));
                    ...
                    if (this.$school) {//todo:联动
                        this.$school.on(EVENT_CHANGE, this.onChangeSchool = $.proxy(function () {
                            return _this2.output(PROFESSION,true);
                        }, this));
                    }
                }
            }, {
                ...
                key: "output",
                value: function output(type) { console.log(type);  //todo:联动
                    ...
                    switch (type) {
                        ...
                        case CITY:
                            code = this.$province && (this.$province.find(':selected').data('code') || '');console.log(code);
                            break;

                        case DISTRICT:
                            code = this.$city && (this.$city.find(':selected').data('code') || '');console.log(code);
                            break;
                        case SCHOOL:  //todo:联动
                            code = this.$district && (this.$district.find(':selected').data('code') || '');console.log(code);
                            break;
                        case PROFESSION:  //todo:联动
                            code = this.$school && (this.$school.find(':selected').data('code') || '');console.log(code);
                            break;
                    }
                    ...
                    if (!matched) {
                        ...
                        if (data.length && (
                            type === PROVINCE && autoselect > 0
                            || type === CITY && autoselect > 1
                            || type === DISTRICT && autoselect > 2
                            || type === SCHOOL && autoselect > 3  //todo:联动
                            || type === PROFESSION && autoselect > 4  //todo:联动
                        )) {
