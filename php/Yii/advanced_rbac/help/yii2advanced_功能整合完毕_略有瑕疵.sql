...
INSERT INTO `menu` VALUES ('2', '角色列表', '1', '/admin/role/index', '2', 0x75736572);
INSERT INTO `menu` VALUES ('3', '权限列表', '1', '/admin/permission/index', '3', null);
INSERT INTO `menu` VALUES ('4', '路由列表', '1', '/admin/route/index', '4', null);
INSERT INTO `menu` VALUES ('5', '规则管理', '1', '/admin/rule/index', '5', null);
INSERT INTO `menu` VALUES ('6', '分配用户到角色', '1', '/admin/assignment/index', '6', null);
INSERT INTO `menu` VALUES ('7', '菜单列表', '1', '/admin/menu/index', '7', 0x66696C65);
INSERT INTO `menu` VALUES ('8', '用户列表', '1', '/admin/user/index', '8', 0x7573657273);
INSERT INTO `menu` VALUES ('9', '图书列表', '1', '/book/index', '9', 0x636F6C756D6E73);
